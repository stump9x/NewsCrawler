...
POLICY_VERSION = "2026-09-topics-v1"
...
CHINA = "Trung Quốc|China|Chinese|Beijing|Bắc Kinh|中国|中方|国务院|Quốc vụ viện|Quảng Tây|Guangxi|广西|Vân Nam|Yunnan|云南|Hải Nam|Hainan|海南|Quảng Châu|Guangzhou|广州|Phòng Thành Cảng|Fangchenggang|防城港|Long Châu|Longzhou|龙州"
VIETNAM = "Việt Nam|Vietnam|Viet Nam|Vietnamese|越南|Hà Nội|Hanoi|Tô Lâm|To Lam|Ngũ Hành Sơn|Đà Nẵng|Quốc hội khóa XVI|QH khóa XVI|Trung ương Đảng Việt Nam|TWĐ|23-NQ/TW"
REGION = CHINA + "|" + VIETNAM + "|Nhật Bản|Japan|Japanese|日本|Đài Loan|Taiwan|Taiwanese|台湾|臺灣|Philippines|Philippine|菲律宾|Malaysia|马来西亚|Indonesia|Indonesian|IND|印尼|Singapore|Xin-ga-po|新加坡|Campuchia|Cambodia|Cambodian|柬埔寨|Lào|Laos|Lao|老挝|Thái Lan|Thailand|Thai|泰国|Myanmar|缅甸|Úc|Australia|Australian|澳大利亚|Mỹ|Hoa Kỳ|United States|U.S.|US Navy|US military|美国|Nga|Russia|Russian|俄罗斯|Ấn Độ|India|Indian|印度"
SEA = "Biển Đông|South China Sea|West Philippine Sea|南海|Xca-bơ-rô|Scarborough|Huangyan|黄岩岛|Cỏ Mây|Second Thomas|Ayungin|仁爱礁|Hoa Lau|Swallow Reef|Layang Layang|弹丸礁|Trường Sa|Spratly|南沙|Hoàng Sa|Paracel|西沙"
...
DEVELOPMENT += "|thông báo|bổ sung|xây dựng|hiện đại hóa|sửa chữa|đóng mới|publish|publishes|published|modernisation|build|builds|building"
VIETNAM += "|VN"
...
TOPICS = (
    Topic("1a", "Biển Đông: hiện diện, chấp pháp và thực địa", SEA,
          "tuần tra|huấn luyện|diễn tập|hải cảnh|cảnh sát biển|chấp pháp|quân sự|tàu chiến|va chạm|đâm va|vòi rồng|ra-đa|radar|căn cứ|bồi đắp|triển khai|coast guard|patrol|patrols|exercise|exercises|naval|military|collision|clash|water cannon|radar|reclamation|deployment|海警|巡航|演习|军事|碰撞|雷达|填海"),
    ...
    Topic("2a", "Trung Quốc: biên giới, cửa khẩu và ven biển", CHINA,
          "biên giới|cửa khẩu|xuất nhập cảnh|xuất cảnh|hoàn thuế|khai hải|mở biển|khai biển|Phòng Thành Cảng|Vân Nam|border|port modernization|border crossing|entry and exit|exit-entry|immigration regulation|departure tax refund|fishing season|Fangchenggang|Yunnan|边境|边防|口岸|出入境|离境退税|开海|防城港|云南",
    ...
    Topic("3a", "Tổ chức và chiến lược quốc phòng, an ninh", REGION,
          "Cục Tình báo Quốc gia|Sách trắng Quốc phòng|chiến lược quốc phòng|chiến lược an ninh quốc gia|cơ quan tình báo|national intelligence|defense white paper|defence white paper|defense strategy|defence strategy|national security strategy|intelligence agency|国家情报|国防白皮书|国防战略|国家安全战略"),
    ...
    Topic("3c", "Chính sách công nghệ và hiện đại hóa quốc phòng", REGION,
          ...
          "chính sách|phát biểu|đánh giá|hội nghị|nâng cấp|hiện đại hóa|speech|assessment|policy|conference|upgrade|modernization|modernisation|讲话|评估|政策|大会|升级|现代化"),
    Topic("4a", "Diễn tập, huấn luyện và hoạt động quân sự", REGION + "|SEACAT|Hán Quang|Han Kuang|汉光|Guam|关岛",
          "diễn tập|huấn luyện|hoạt động quân sự|hợp tác hàng hải|phòng thủ đô thị|SEACAT|Hán Quang|Han Kuang|exercise|exercises|drill|drills|military training|naval training|military operation|military operations|maritime cooperative activity|military deployment|演习|军演|军事训练|海军训练|军事行动|汉光",
          "quân sự|quân đội|QĐ|hải quân|tàu chiến|phòng thủ|hàng hải đa phương|Hán Quang|Han Kuang|SEACAT|military|naval|navy|army|marines|air force|defense|defence|maritime cooperative|军演|军事|军队|海军|空军|汉光"),
    Topic("4b", "Hợp tác quốc phòng, biên giới và chuyển giao trang bị", REGION,
          "hợp tác quốc phòng|hỗ trợ an ninh|Bộ trưởng Quốc phòng|Ủy ban biên giới chung|Stryker|mua sắm quốc phòng|chuyển giao vũ khí|tiếp nhận tàu|defense cooperation|defence cooperation|security assistance|defense ministers|defence ministers|joint border committee|arms transfer|military aid|air-defense missile agreement|防务合作|安全援助|国防部长|联合边界|武器转让|军事援助",
          "hội nghị|kết quả|thỏa thuận|ký|tiếp nhận|bàn giao|chuyển giao|hỗ trợ|hợp tác|chuẩn bị|mua sắm|agreement|sign|signs|signed|receive|receives|received|deliver|delivers|delivered|transfer|conference|meeting|assistance|aid|cooperation|procurement|会议|协议|接收|交付|援助|合作"),
    Topic("4c", "Học thuyết, hệ thống phòng thủ và công nghệ mới", REGION + "|Guam|关岛",
          "học thuyết|Lá chắn ba mũi giáo|phòng thủ ở đảo Guam|phòng thủ Guam|chỉ huy - điều khiển|chỉ huy-điều khiển|chỉ huy điều khiển|tàu không người lái|mạng 6G|nghiên cứu 6G|trí tuệ nhân tạo tiếng Lào|doctrine|Guam missile defense|Guam missile defence|command and control|command-and-control|unmanned trimaran|uncrewed trimaran|unmanned surface vessel|6G network|6G research|Lao language AI|Lao-language AI|作战理论|关岛防御|指挥控制|无人艇|6G研发|老挝语人工智能",
          "phát triển|triển khai|xây dựng|nâng cấp|nghiên cứu|đề xuất|hỗ trợ|học thuyết|develop|develops|development|deploy|deploys|deployment|build|builds|building|upgrade|upgrades|research|propose|proposes|support|doctrine|研发|发展|部署|建设|升级|研究|援助|理论"),
    Topic("5", "Trừng phạt, đối phó và kiểm soát xuất khẩu", CHINA + "|Mỹ|Hoa Kỳ|United States|U.S.|USTR|美国|Nga|Russia|俄罗斯|Liên minh Châu Âu|European Union|EU|欧盟",
          ...
          "đưa|bổ sung|ban hành|công bố|thông báo|áp dụng|tăng cường|kết luận|điều tra|announce|announces|announced|add|adds|added|impose|imposes|imposed|list|lists|listed|investigation|findings|tighten|tightens|expand|expands|publish|publishes|发布|公布|列入|新增|实施|调查|反制"),
    Topic("6", "Chuyến thăm và đối ngoại quốc phòng liên quan Việt Nam", VIETNAM,
          "chuyến thăm|thăm Việt Nam|thăm VN|công du|tàu sân bay|biên đội tàu|triển lãm quốc phòng|state visit|official visit|visit to Vietnam|visits Vietnam|carrier visit|port visit|defense expo|defence expo|访问|访越|航母|防务展",
          "lãnh đạo|TBT|CTN|Tổng Bí thư|Chủ tịch|Bộ trưởng|hải quân|tàu sân bay|CVN-73|quốc phòng|biểu tình|dư luận|phản ứng|leader|president|minister|general secretary|navy|naval|carrier|defense|defence|protest|reaction|领导人|主席|部长|总书记|海军|航母|防务|抗议"),
    Topic("7", "Dư luận công khai về sự kiện và chính sách Việt Nam", VIETNAM,
          "nghị quyết|NQ số|23-NQ/TW|kỳ họp|Quốc hội|QH khóa|Hội nghị Trung ương|Hội nghị lần thứ|CAND|công an|Ngũ Hành Sơn|resolution|national assembly|central committee|public security|Marble Mountains|国会|决议|公安|五行山",
          "phát tán|bài viết|dư luận|thông tin sai|xuyên tạc|chống phá|hiển thị|gán nhầm|biểu tình|phản ứng|chiến dịch|misinformation|disinformation|false claim|falsely|mislabel|mislabeled|mislabelled|online reaction|online campaign|public reaction|circulating|虚假信息|错误标注|舆论|抗议"),
)
TOPIC_LABELS = {topic.tag: f"{topic.code.upper()}. {topic.label}" for topic in TOPICS}
...
class TopicMatch:
    codes: tuple[str, ...] = ()
    evidence: tuple[str, ...] = ()
    reason: str = "Không có diễn biến cụ thể thuộc bảy nhóm nhiệm vụ"
    ...
    for topic in TOPICS:
        for title in titles:
            ...
            for text in candidates:
                ...
                if not all(matches):
                    continue
                # Every required signal must be within 420 characters. A
                # document mentioning China once cannot qualify distant news.
                for context_match in matches[0]:
                    start = max(0, context_match.start() - 210)
                    passage = text[start:context_match.end() + 210]
...
WIRE_DISCOVERY_QUERIES = (
    ...
    'Vietnam official state visit defense leaders naval carrier port visit international defense expo public reactions',
    'Vietnam national assembly resolution overseas Vietnamese policy Marble Mountains online misinformation public reactions',
)
