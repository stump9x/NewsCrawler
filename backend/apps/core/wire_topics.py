...
TOPICS = (
    ...
    Topic("1b", "Biển Đông: biện pháp chủ quyền", SEA,
          "biện pháp quản lý|khu bảo tồn|du lịch|đánh bắt chung|chủ quyền|tuyên truyền pháp lý|lệnh cấm đánh bắt|cấm đánh bắt|phân định|quyền tài phán|thực thi pháp luật biển|nature reserve|tourism|joint fishing|sovereignty|fishing ban|maritime law|maritime jurisdiction|administrative measures|maritime claim|自然保护区|旅游|共同捕鱼|主权|禁渔|管控|海洋法|管辖权"),
    ...
    Topic("3a", "Tổ chức và chiến lược quốc phòng, an ninh", REGION,
          "Cục Tình báo Quốc gia|Sách trắng Quốc phòng|chiến lược quốc phòng|chiến lược an ninh quốc gia|cơ quan tình báo|thế trận quốc phòng|tổ chức lực lượng|national intelligence|defense white paper|defence white paper|defense strategy|defence strategy|national security strategy|intelligence agency|defense posture|force posture|military reorganization|defense cyber strategy|military cyber strategy|cyber strategy|国防部网络战略|网络战略|網路戰略|国家情报|国防白皮书|国防战略|国家安全战略|军事战略|国防体制",
    ...
    Topic("3b", "Hội nghị, quyết sách chính trị và đối ngoại", REGION,
          "Đảng Nhân dân Cách mạng Lào|Hội nghị Trung ương|Hội nghị TW|Trung ương Đảng|Ban Chấp hành TW|Hội đồng Bộ trưởng|Bộ Ngoại giao|BNG Trung Quốc|hội nghị thượng đỉnh|định hướng đối ngoại|chính sách đối ngoại|Lao People's Revolutionary Party|central committee plenum|central committee meeting|party plenum|council of ministers|foreign ministry|summit|foreign policy|cabinet decision|diplomatic briefing|中全会|中央全会|部长会议|外交部|峰会|外交政策",
...
WIRE_DISCOVERY_QUERIES = (
    'South China Sea maritime security territorial dispute coast guard naval patrol exercise collision radar reef latest developments',
    'South China Sea sovereignty maritime law jurisdiction fishing ban nature reserve tourism administrative measures policy',
    'China border management border security port modernization entry exit immigration Guangxi Yunnan coastal development policy',
    'China defense security military policy naval shipbuilding warships foreign NGO civil explosives container combat dual use minerals',
    'China strategic technology energy nuclear power integrated circuits IPv6 artificial intelligence marine economy transport infrastructure plan',
    'Indo-Pacific national intelligence agency defense white paper defense posture national security strategy cyber strategy announcement',
