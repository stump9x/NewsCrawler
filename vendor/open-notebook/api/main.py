...
# NewsCrawler Notebook AI: speech/podcast (TTS/STT) disabled unless explicitly re-enabled.
_disable_speech = os.environ.get("OPEN_NOTEBOOK_DISABLE_SPEECH", "1").lower() in (
    "1",
    "true",
    "yes",
    "on",
)
if not _disable_speech:
