import { MessageSquare, Code, Box } from 'lucide-react'
...
// edit.
//
// NewsCrawler Notebook AI: TTS/STT modalities are disabled.
...
const TYPE_ICONS: Record<ModelType, React.ReactNode> = {
  ...
  text_to_speech: <Box className="h-3 w-3" />,
  speech_to_text: <Box className="h-3 w-3" />,
}
